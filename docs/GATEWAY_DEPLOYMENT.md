...
```text
Installer:          GatewayPulseSetup_v1.2.4.exe
...
```text
GatewayPulseSetup_v1.2.4.exe
GatewayPulseSetup_v1.2.4.sha256.txt
```

Verify before running:

```powershell
Get-FileHash .\GatewayPulseSetup_v1.2.4.exe -Algorithm SHA256
Get-Content .\GatewayPulseSetup_v1.2.4.sha256.txt
```
...
```powershell
Start-Process .\GatewayPulseSetup_v1.2.4.exe -Verb RunAs -Wait
```
