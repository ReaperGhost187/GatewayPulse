...
public static class PowerTelemetryJson
{
    ...
    public static string Serialize(PowerTelemetry telemetry) =>
        JsonSerializer.Serialize(telemetry, Options);

    public static PowerTelemetry? Deserialize(string json) =>
        JsonSerializer.Deserialize<PowerTelemetry>(json, Options);
